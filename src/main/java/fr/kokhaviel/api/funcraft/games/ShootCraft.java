...
public class ShootCraft extends Game {
	...
	public ShootCraft(Element shootCraftStats) {
		final Element playerStats = shootCraftStats.getElementsByClass("player-stats-game").first();
		final Element playerStatsInfo = playerStats.getElementsByClass("player-stats-info").first();

		this.setGameName(playerStats.getElementsByClass("name game-border-shootcraft").first().text());
