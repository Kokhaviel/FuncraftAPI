...
public class Octogone extends Game {
	...
	public Octogone(Element octogoneElement) {
		final Element playerStats = octogoneElement.getElementsByClass("player-stats-game").first();
		final Element playerStatsInfo = playerStats.getElementsByClass("player-stats-info").first();

		this.setGameName(playerStats.getElementsByClass("name game-border-mma").first().text());
