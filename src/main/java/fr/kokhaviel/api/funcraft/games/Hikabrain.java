...
public class Hikabrain extends Game {
	...
	public Hikabrain(Element hikabrainElement) {
		playerStats = hikabrainElement.getElementsByClass("player-stats-game").first();
	...
	public String getGameName() {
		return playerStats.getElementsByClass("name game-border-hikabrain").first().text();
	}
