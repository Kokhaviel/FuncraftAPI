...
public class RushRetro extends Game {
	...
	private void setStats(Element playerStatsInfo) {

		final Element leaderBoardElement = playerStatsInfo.getElementsByClass("stats-entry").get(0);
		final Element pointsElement = playerStatsInfo.getElementsByClass("stats-entry").get(1);
		final Element gamesElement = playerStatsInfo.getElementsByClass("stats-entry").get(2);
		...
		final Element playedTimeElement = playerStatsInfo.getElementsByClass("stats-entry").get(5);
		final Element killsElement = playerStatsInfo.getElementsByClass("stats-entry").get(6);
		final Element deathsElement = playerStatsInfo.getElementsByClass("stats-entry").get(7);
